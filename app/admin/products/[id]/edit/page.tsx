...
export default function EditProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Upload replacement image if selected or AI generated
      if (selectedFile) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Card 2: Image Management (Upload & AI Studio) */}
        <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-2">
              <span className="text-xs font-bold text-charcoal block">Replace With New / AI Image</span>
              {imagePreview ? (
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-3 mt-1.5">
                      <button
                        ...
                        onClick={() => handleGenerateAIImage(aiCustomImgPrompt || undefined)}
                        disabled={generatingImg}
                        className="inline-flex items-center gap-1 text-[11px] text-secondary hover:text-secondary-dark font-bold cursor-pointer"
                      >
